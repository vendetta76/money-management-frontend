...
import {
  ...
  Check as CheckIcon,
  Info as InfoIcon
} from '@muiicons-material';
import { formatCurrency, getCurrencySymbol, getCurrencyType } from '..helpersformatCurrency';
...
const CollapsibleCurrencyView React.FCCollapsibleCurrencyViewProps = ({
  availableCurrencies,
  displayCurrency,
  onCurrencyChange,
  ...
  const [viewMode, setViewMode] = useStateViewMode('compact');
