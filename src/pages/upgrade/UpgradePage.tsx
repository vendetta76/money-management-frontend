  ...
  return (
    <LayoutShell>
      <main className="2xl:px-20 max-w-screen-md md:ml-64 md:px-8 mx-auto px-4 py-10 sm:px-6 xl:px-12">
        <h1 className="font-bold mb-6 text-3xl text-center">🚀 Upgrade ke Premium</h1>
        ...
        <div className="bg-white border dark:bg-gray-800 dark:bg-gray-900 dark:border-gray-700 p-6 rounded-lg shadow-lg">
          <h2 className="font-semibold mb-2 text-2xl">💎 MoniQ Premium</h2>
          ...
          <div className="dark:text-purple-400 font-bold mb-4 text-2xl text-center text-purple-600">
            Rp25.000 / bulan
          </div>
          ...
          <div className="text-center">
            <button
              ...
              className="bg-gradient-to-r font-semibold from-[#00d97e] hover:shadow-lg px-6 py-2 rounded-lg text-white to-[#00c2ff] transition"
            >
              Upgrade Sekarang
            </button>
          </div>
