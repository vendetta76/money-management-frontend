...
const AboutPage = () => {
  return (
    <LayoutShell>
      <main className="max-w-screen-md mx-auto px-4 sm:px-6 md:px-8 xl:px-12 2xl:px-20 py-10 md:ml-64">
        <h1 className="text-3xl font-bold mb-6">Tentang Moniq</h1>
        ...
        <section className="space-y-5 text-sm text-gray-700 leading-relaxed">
          ...
          <h2 className="text-lg font-semibold">Fitur Utama Moniq</h2>
          ...
          <h2 className="text-lg font-semibold">Tidak Menggunakan Uang Asli</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold">Tim Pengembang</h2>
          <p>
