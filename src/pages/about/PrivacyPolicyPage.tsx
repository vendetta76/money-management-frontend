  ...
  return (
    <LayoutShell>
      <main className="2xl:px-20 max-w-screen-md md:ml-64 md:px-8 mx-auto px-4 py-10 sm:px-6 xl:px-12">
        <h1 className="dark:text-white font-bold mb-6 text-3xl">Kebijakan Privasi</h1>
        ...
        <section className="dark:text-white leading-relaxed space-y-5 text-gray-700 text-sm">
          ...
          <h2 className="dark:text-white font-semibold text-lg">1. Informasi yang Kami Kumpulkan</h2>
          ...
          <h2 className="dark:text-white font-semibold text-lg">2. Bagaimana Data Digunakan</h2>
          <p>
          ...
          <h2 className="dark:text-white font-semibold text-lg">3. Keamanan Data</h2>
          <p>
          ...
          <h2 className="dark:text-white font-semibold text-lg">4. Tidak Ada Transaksi Finansial Nyata</h2>
          <p>
          ...
          <h2 className="dark:text-white font-semibold text-lg">5. Kontak</h2>
          <p>
