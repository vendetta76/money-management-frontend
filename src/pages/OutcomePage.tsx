  ...
  return (
    <LayoutShell>
      <main className="2xl:px-20 max-w-screen-2xl md:ml-64 md:px-8 min-h-screen mx-auto pt-4 px-4 sm:px-6 w-full xl:px-12">
        <h1 className="dark:text-red-400 dark:text-white font-bold mb-6 text-2xl text-red-600">
        ...
        <div className="mt-8">
          <h2 className="dark:text-white font-semibold mb-4 text-xl">Transaksi Pengeluaran</h2>
          {outcomes.length === 0 ? (
