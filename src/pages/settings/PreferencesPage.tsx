  ...
  return (
    <LayoutShell>
      <main className="2xl:px-20 max-w-screen-md md:ml-64 md:px-8 min-h-screen mx-auto pt-4 px-4 sm:px-6 w-full xl:px-12">
        <h1 className="dark:text-white font-bold mb-4 text-2xl">⚙️ Preferensi</h1>
        <div className="flex items-center justify-between mb-4">
          ...
          <label className="cursor-pointer inline-flex items-center relative">
            ...
            />
            <div className="bg-gray-200 dark:bg-gray-700 dark:bg-gray-900 duration-300 h-5 peer peer-checked:bg-purple-600 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-purple-400 relative rounded-full transition w-9">
