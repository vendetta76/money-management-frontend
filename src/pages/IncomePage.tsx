  ...
  return (
    <LayoutShell>
      <main className="dark:text-white dark:bg-gray-900 min-h-screen w-full px-4 sm:px-6 md:px-8 xl:px-12 2xl:px-20 md:ml-64 pt-4 max-w-screen-2xl mx-auto">
        <h1 className="dark:text-white dark:bg-gray-900 text-2xl font-bold mb-6">{editingId ? "Edit Pemasukan" : "Tambah Pemasukan"}</h1>
        ...
        <form onSubmit={handleSubmit} className="dark:text-white dark:bg-gray-900 bg-white dark:bg-gray-900 shadow rounded-xl p-6 mb-6 max-w-xl w-full">
          ...
          <div className="dark:text-white dark:bg-gray-900 mb-4">
            <label className="dark:text-white dark:bg-gray-900 block mb-1 text-sm font-medium">Nominal</label>
            <input
              name="amount"
              value={form.amount}
              onChange={handleChange}
          ...
          <div className="dark:text-white dark:bg-gray-900 mb-4">
            <label className="dark:text-white dark:bg-gray-900 block mb-1 text-sm font-medium">Mata Uang</label>
            <input
              type="text"
              value={form.currency}
              disabled
        ...
        <div className="dark:text-white dark:bg-gray-900 mt-8">
          <h2 className="dark:text-white dark:bg-gray-900 text-xl font-semibold mb-4">Transaksi Terbaru</h2>
          {incomes.length === 0 ? (
            <p className="dark:text-white dark:bg-gray-900 text-gray-500 dark:text-gray-300">Belum ada data pemasukan.</p>
          ) : (
