          ...
          <div className="mb-4">
            <div className="relative">
              ...
              <input
                ...
                value={form.amount}
                onChange={handleChange}
                className={`pl-10 pr-4 py-2 w-full border rounded-lg bg-transparent focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white ${
