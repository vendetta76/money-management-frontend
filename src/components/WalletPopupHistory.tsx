...
import { Dialog, DialogContent, DialogTitle, DialogPanel } from "@/components/ui/dialog";
    ...
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          ...
          >
            <DialogPanel className="w-[95%] max-w-lg p-4 sm:p-6 bg-white rounded-xl shadow-xl max-h-[90vh] overflow-y-auto">
